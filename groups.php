...
<?php
  $title = "{$noti->titleNoti()} {$groups->GETgrp($grp, 'grp_name')} • Horizon";
  $keywords = "Horizon, Share and capture world's moments";
  $desc = "View group • Horizon";
?>
...
<div class="ciphertext">
  <?php include 'ajaxavi/groups/grp_banner.php'; ?>
  ...
  <?php } else { ?>
    ...
    <?php include 'ajaxavi/groups/grp_hori_nav.php'; ?>
...
<?php include_once 'ajaxavi/groups/view_profile.php'; ?>
...
$(function(){
  ...
  function fetch(elem){
    ...
    $.ajax({
      url: DIR+"/ajaxavi/grp_sections/"+elem+".php",
      method: "GET",
      cache: false,
      data: {grp: grp},
