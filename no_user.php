...
<?php
  $title = "{$noti->titleNoti()} Member not found • Horizon";
  $keywords = "eror, 404, document not found, webpage not found, Horizon, Share and capture world's moments";
  $desc = "There's been an error • Horizon";
?>
...
<?php
  if ($universal->isLoggedIn()) {
    ...
    include 'index/index_header.php';
  }
?>
...
if ($universal->isLoggedIn()) {
  ...
  include 'index/index_footer.php';
}
?>
