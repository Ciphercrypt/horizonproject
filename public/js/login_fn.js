...
(function($){
  $.fn.passwordRetrieval = function(options){
    ...
    form.on('submit', (function(e){
      ...
      $.ajax({
        url   : DIR+"/ajaxavi/ajax_requests/forgot_requests.php",
        method: "POST",
...
(function($){
  $.fn.username_checker = function(options){
    ...
    this.on('keyup', function(e){
      ...
      if (value != "") {
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/u_checker_requests.php",
          method: "GET",
          data: {value: value},
          success: function(data){
...
function login(ju, jp, btn){
  $.ajax({
    url: DIR+"/ajaxavi/ajax_requests/login_requests.php",
    method: "POST",
    dataType: "json",
    data: {
      username: ju,
