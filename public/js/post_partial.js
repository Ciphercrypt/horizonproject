  ...
  $.fn.postDefaults = function(options){
    this.each(function(e){
      ...
      tag_input.on('keyup', function (){
        ...
        if (newValue != "") {
          $.ajax({
            url: "ajaxavi/ajax_requests/get_taggers.php",
            method: "GET",
            data: {
              value: newValue,
...
(function($){
  $.fn.textPost = function(options){
    ...
    elem.on('click', function(e){
      $.ajax({
        url: DIR+"/ajaxavi/post/text_post.php",
        beforeSend: function(){
          $('.overlay').show();
          blur.addBlur();
          div.show();
        ...
        success: function(data){
          ...
          function textPost(el){
            ...
            if (value.val() != "") {
              ...
              $.ajax({
                url: DIR+"/ajaxavi/ajax_requests/post_requests.php",
                data: {
                  text: value.val(),
    ...
    elem.on('change', function(e){
      ...
      if (!((type == allowed[0]) || (type == allowed[1]) || (type == allowed[2]))) {
        ...
        reader.onload = function(e){
          ...
          $.ajax({
            url: DIR+"/ajaxavi/post/image_post.php",
            beforeSend: function(){
              $('.overlay').show();
              blur.addBlur();
              div.show();
    ...
    elem.on('change', function(e){
      ...
      if (!((type == allowed[0]) || (type == allowed[1]) || (type == allowed[2]))) {
        ...
        reader.onload = function(e){
          ...
          $.ajax({
            url: DIR+"/ajaxavi/post/video_post.php",
            beforeSend: function(){
              $('.overlay').show();
              blur.addBlur();
              div.show();
  ...
  $.fn.audioPost = function(options){
    ...
    elem.on('change', function(e){
      ...
      if (!((type == allowed[0]) || (type == allowed[1]))) {
        ...
        $.ajax({
          url: DIR+"/ajaxavi/post/audio_post.php",
          beforeSend: function(){
            $('.overlay').show();
            blur.addBlur();
            div.show();
  ...
  $.fn.docPost = function(options){
    ...
    elem.on('change', function(e){
      ...
      if (((type == allowed[0]) || (type == allowed[1]) || (type == allowed[2]) || (type == allowed[3]) || (type == allowed[4]) || (type == allowed[5]) || (type == allowed[6]) || (type == allowed[7]))) {
        ...
        $.ajax({
          url: DIR+"/ajaxavi/post/document_post.php",
          beforeSend: function(){
            $('.overlay').show();
            blur.addBlur();
            div.show();
...
(function($){
  $.fn.locationPost = function(options){
    ...
    elem.on('click', function(e){
      ...
      $.ajax({
        url: DIR+"/ajaxavi/post/location_post.php",
        beforeSend: function(){
          $('.overlay').show();
          blur.addBlur();
          div.show();
...
(function($){
  $.fn.linkPost = function(options){
    ...
    elem.on('click', function(e){
      ...
      $.ajax({
        url: DIR+"/ajaxavi/post/link_post.php",
        beforeSend: function(){
          $('.overlay').show();
          blur.addBlur();
          div.show();
    ...
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        save.on('click', function(e){
          ...
          e.preventDefault();
          $.ajax({
            url: DIR+"/ajaxavi/ajax_requests/edit_post_requests.php",
            type: "POST",
            data: {
              edit: "yes",
              text: text,
  ...
  $.fn.postLike = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/post_like_requests.php",
          dataType: "JSON",
          data: {
            // like: user,
            like: post
  ...
  $.fn.postBookmark = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        var parent = $(this).parent();
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/bkmrk_requests.php",
          data: {bkmrk: post},
          success: function(data){
            console.log(data);
            $(this).removeClass('post_like_toggle');
  ...
  $.fn.postShare = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/share_requests.php",
          method: "POST",
  ...
  $.fn.taggers = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/taggings_requests.php",
          method: "POST",
          data: {post: post},
          beforeSend: function(){
            $('.display_content').html("<div class='spinner'><span></span><span></span><span></span></div>");
