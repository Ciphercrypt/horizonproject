...
var blur_page = function(){
  this.addBlur = function(){
    $('.ciphertext, .m_n_wrapper, div.header, .login_container, .index_header, .quick_login').addClass('blur_page');
  }
  this.removeBlur = function(){
    $('.ciphertext, .m_n_wrapper, div.header, .login_container, .index_header, .quick_login').removeClass('blur_page');
  }
}
  ...
  $.fn.changeAvatar = function(options){
    this.each(function(e){
      ...
      apply.on('click', function(e){
        e.preventDefault();
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/change_avatar.php",
          method: "GET",
  ...
  $.fn.uploadAvatar = function(options){
    this.each(function(e){
      ...
      form.on('submit', (function(e){
        e.preventDefault();
        $.ajax({
          url: '../ajaxavi/ajax_requests/change_avatar.php',
          contentType: false,
          processData: false,
          dataType: "json",
          method: "POST",
  ...
  $.fn.follow = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        e.preventDefault();
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/follow_requests.php",
          method: "GET",
          dataType: "json",
...
(function($){
  $.fn.profileViewers = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        $.ajax({
          url: "../ajaxavi/ajax_requests/follow_requests.php",
          method: "GET",
  ...
  $.fn.sticker = function(options){
    ...
    elem.on('click', function(e){
      ...
      function rr(data){
        ...
        if (value != "") {
          $.ajax({
            url: DIR+"/ajaxavi/ajax_requests/message_requests.php",
            data: data,
            dataType: "JSON",
            beforeSend: function(){
      ...
      if (settings.when == "message") {
        ...
        div.find('.sti_done').on('click', function(e){
          ...
          if (value != "") {
            $.ajax({
              url: DIR+"/ajaxavi/ajax_requests/post_comment_requests.php",
              data: {
                commSticker: value,
              ...
              success: function(data){
                ...
                $('.notify').notify({value: "You gave a stand"});
  ...
  $.fn.editProfile = function(options){
    ...
    function updating(e){
      ...
      if (username.val() == "") {
        ...
        o2.show();
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/edit_requests.php",
          method: "POST",
          dataType: "JSON",
          data: {
  ...
  $.fn.profileNav = function(options){
    this.each(function(e){
      ...
      var fetchAndInsert = function(href){
        $.ajax({
          url: DIR+'/ajaxavi/profile_sections/'+href.split('=').pop(),
          method: "GET",
          data: {u: username},
  ...
  $.fn.recommend = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/recommend_requests.php",
          method: "POST",
    ...
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $('.prompt').myPrompt({
          ...
          value: username+" will no longer be able to follow, message, comment, recommend or add you in any group. Horizon won't let "+ username+" know you blocked him/her. You can unblock from settings.",
          doneText: "Block",
          type: "block_user",
          post: $(this)
        });
  ...
  $.fn.unblock = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $.ajax({
          url    : DIR+"/ajaxavi/ajax_requests/settings_requests.php",
  ...
  $.fn.getUnread = function(options){
    ...
    var elem = this;
      ...
      setInterval(function () {
        $.ajax({
          url     : DIR+"/ajaxavi/ajax_requests/notifications_requests.php",
          method  : "GET",
          dataType: "JSON",
          data    : {getUnread: "Avishkar "},
          success : function(data){
...
(function($){
  $.fn.HomeSuggestions = function(options){
    ...
    refresh.on('click', function(e){
      e.preventDefault();
      $.ajax({
        url : DIR+"/ajaxavi/ajax_requests/suggestions_requests.php",
...
(function($){
  $.fn.exploreNav = function(options){
    this.each(function(e){
      ...
      var fetchAndInsert = function(href){
        $.ajax({
          url: DIR+'/ajaxavi/explore/'+href.split('=').pop(),
          method: "GET",
          beforeSend: function(e){
  ...
  $.fn.searchinstagram = function(options){
    ...
    elem.on('keyup', function(e){
      ...
      if (value == "") {
        ...
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/search_requests.php",
  ...
  $.fn.userFav = function(options){
    this.each(function(e){
      ...
      elem.on('click', function(e){
        ...
        $.ajax({
          url: DIR+"/ajaxavi/ajax_requests/fav_requests.php",
          data: {userFav: get},
          success: function(data){
            console.log(data);
...
function hashtagFeeds(){
  $(window).on('scroll', function(e){
    if ($(window).scrollTop() + $(window).height() == $(document).height()) {
      ...
      $.ajax({
        url: DIR+"/ajaxavi/ajax_requests/hashtag_requests.php",
        data: {
