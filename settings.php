...
<?php
  $title = "{$noti->titleNoti()} Account settings • Horizon";
  $keywords = "Horizon, Share and capture world's moments, share, capture, settings";
...
<div class="ciphertext">
  <div class="ajinkyacss">
    ...
    <div class="aviclass settings_aviclass">
    ...
    <div class="mohitecss settings_rajkumar">
...
<script type="text/javascript">
  $(function(){
    ...
    function fetch(elem){
      ...
      $.ajax({
        url: DIR+"/ajaxavi/settings/"+elem+".php",
        method: "GET",
        cache: false,
