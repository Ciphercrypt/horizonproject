...
<?php
  $title = "{$noti->titleNoti()} @{$universal->GETsDetails($get_id, "username")} ({$universal->GETsDetails($get_id, "firstname")} {$universal->GETsDetails($get_id, "surname")}) • Horizon";
  $keywords = "{$universal->GETsDetails($get_id, "username")}, {$universal->GETsDetails($get_id, "firstname")}, {$universal->GETsDetails($get_id, "surname")}, Horizon, Share and capture world's moments";
  $desc = "Connect with {$universal->GETsDetails($get_id, "username")}'s profile • Horizon";
?>
...
<div class="ciphertext">
  <?php include_once 'ajaxavi/profile/profile_banner.php'; ?>
  <?php
    if($universal->isLoggedIn() == false){
  ...
  <?php include_once 'ajaxavi/profile/profile_hori_nav.php'; ?>
  <div class="hmm">
    <div class="spinner">
...
<?php include_once 'ajaxavi/profile/view_profile.php'; ?>
...
<script type="text/javascript">
  $(function(){
    ...
    function fetch(elem){
      ...
      $.ajax({
        url: DIR+"/ajaxavi/profile_sections/"+elem+".php",
        method: "GET",
        cache: false,
        data: {u: username},
