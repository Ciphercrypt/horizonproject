...
<?php
  $title = "{$noti->titleNoti()} Messages • Horizon";
  $keywords = "Horizon, Share and capture world's moments, share, capture, messages";
...
<div class="ciphertext mssg_ciphertext">
...
<script type="text/javascript">
  $(function(e){
    ...
    //       var n = new Notification('Horizon', {
    //         body: "Wlecome to Horizon!",
