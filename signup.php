  ...
  <div class="input_wrapper">
    ...
    <div class="sign_up_div">
      <form class="sign_up" id="sign_up" action="" method="post">
        ...
        <label for="s_terms" class="terms">I agree to <a href="terms" class="a_pri">Horizon Terms</a></label>
...
<script type="text/javascript">
  $(function(){
    ...
    $('form').on('submit', (function(e){
      ...
      $.ajax({
        url: DIR+"/ajaxavi/ajax_requests/register_requests.php",
        method: 'POST',
        cache: false,
        data: {
          username: username,
