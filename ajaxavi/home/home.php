<div class="ajinkyacss">
  ...
  <div class="mohitecss">
    ...
    <div class="post_it inst">
      ...
      <div class="post_teaser">
        <span class="p_whats_new user_whats_new" data-when='user'>What's happening there, @<?php echo $universal->nameShortener($universal->getUsernameFromSession(), 20); ?>? #awake</span>
        <span data-description="More" id="avi"><i class="material-icons">expand_more</i></span>
      </div>
    </div>
  ...
  <div class="aviclass home_rajkumar" style="margin-right:0%;">
...
window.onload = function(){
  document.getElementById('avi').click();
}
</script>