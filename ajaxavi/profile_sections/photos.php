...
<div class="ajinkyacss pro_ajinkyacss photos_ajinkyacss" id="photos_ajinkyacss">
...
<script type="text/javascript">
  $(function(){
    ...
    var options = {
      container: $('.photos_ajinkyacss'), // Optional, used for some extra CSS styling
    ...
    $('.photos_ajinkyacss').css('height', 'inherit');
