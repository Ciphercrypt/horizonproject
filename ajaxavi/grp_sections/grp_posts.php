...
<div class="ajinkyacss pro_ajinkyacss a_m_senapti">

  <div class="aviclass grp_aviclass">
    ...
    <div class="c_g_div inst">
      <span>Explore more groups from all around Horizon.</span>
      <div class="grp_c_we">
  ...
  <div class="mohitecss a_m_mohitecss">
    ...
    <div class="post_it inst">
      ...
      <div class="post_teaser">
        <span class="p_whats_new grp_whats_new" data-grp='<?php echo $grp; ?>' data-when='group'>What's happening there, @<?php echo $universal->nameShortener($universal->getUsernameFromSession(), 20); ?>? #awake</span>
