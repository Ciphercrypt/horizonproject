  ...
  class forgot{
    ...
    public function retrieve($input){
      ...
      if ($scount == 0) {
        ...
        $mail->setFrom($this->gmail, 'Team Horizon');
        $mail->addAddress($email);               // Name is optional
        $mail->addReplyTo($this->gmail, 'Team Horizon');
        ...
        $mail->Subject = 'Activate your Horizon account';

        $mail->Body = "<span>Hello, You received this message because you created an account on Horizon.<span><br>
        <span>Click on button below to retrieve your Horizon account and explore.</span><br><br>
        <a href='{$url}/ajaxavi/deep/most/topmost/retrieve.php?id={$uid}' style='border: 1px solid #1b9be9; font-weight: 600; color: #fff; border-radius: 3px; cursor: pointer; outline: none; background: #1b9be9; padding: 4px 15px; display: inline-block; text-decoration: none;'>Retrieve</a>";
